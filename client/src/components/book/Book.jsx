...
function Book() {
  ...
  return (
    <div className=" min-h-[600px] w-[70%] mx-auto p-[30px]">
      {book ? (
        <Item className="flex min-h-[500px]">
          <Item.Image size="large" src={book.bookImg} />
          <Item.Content>
            <Item.Header className="text-6xl font-Popins font-extrabold">
              {book.title}
            </Item.Header>{" "}
            <br />
            ...
            <Comment.Group>
              ...
              {reviews.length > 0 ? (
                reviews.map((review) => {
                  ...
                  return (
                    <Comment>
                      <Comment.Avatar src={review.user.userImg} />
                      <Comment.Content>
                        <Comment.Author as="a">
